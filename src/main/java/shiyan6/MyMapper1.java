...
public class MyMapper1 {
    ...
    public static class ReadFilesMapper
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] otherArgs = { "src/main/java/shiyan6/Input/file1", "src/main/java/shiyan6/Input/file2","src/main/java/shiyan6/Input/file3"
        ,"src/main/java/shiyan6/Output"};
        Job job = new Job(conf, "fileinfo");
        job.setJarByClass(shiyan6.MyMapper1.class);
        job.setMapperClass(shiyan6.MyMapper1.ReadFilesMapper.class);
